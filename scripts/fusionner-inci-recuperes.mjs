...
const RECOLTE = path.join(RACINE, "data/scan/inci-recuperes.json");
...
const recolte = JSON.parse(fs.readFileSync(RECOLTE, "utf8"));
...
for (const [x, v] of aEcrire) { x.inci = v.inci; x.inciSource = "recupere-" + (v.via || "page"); }
