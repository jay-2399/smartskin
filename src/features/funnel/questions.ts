...
export const QUESTIONS: Record<string, QuestionDef> = {
  ...
  q1: {
    ...
    options: [
      ...
      { value: "blemishes", label: "Acne & breakouts", sub: "pimples, blackheads",
...
{ value: "allergy-fragrance", label: "Fragrance allergy", sub: "diagnosed \u2014 patch test or doctor",
        icon: `<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="7.3" y="9.5" width="7" height="8.5" rx="2.4"/><path d="M9.6 9.5V6.8h2.8v2.7"/><rect x="9.2" y="4.7" width="3.6" height="2.1" rx="0.6"/><path d="M16.4 5.2l1.4 1.4M17.8 5.2l-1.4 1.4"/></svg>` },
      { value: "allergy-eo", label: "Essential oil allergy", sub: "diagnosed \u2014 not just \u201cit stings\u201d",
        icon: `<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="9.5" y="3.8" width="3" height="7.4" rx="0.6"/><rect x="9.9" y="2.4" width="2.2" height="1.5" rx="0.4"/><path d="M11 13s-1.3 1.5-1.3 2.5a1.3 1.3 0 0 0 2.6 0C12.3 14.5 11 13 11 13Z"/></svg>` },
      { value: "allergy-preservative", label: "Preservative allergy", sub: "isothiazolinones, formaldehyde releasers",
        icon: `<svg width="22" height="22" viewBox="0 0 22 22" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 3.2 5.6 5.4v4.3c0 3.4 2.3 5.9 5.4 6.9 3.1-1 5.4-3.5 5.4-6.9V5.4z"/><path d="M8.8 10.6 11 12.8M13.2 10.6 11 12.8"/></svg>` },
