...
export function buildPrompt(answers: Answers): string {
  return [
    ...
    "- post_acne_marks (marques post-acné) — 1=aucune · 4=nombreuses taches rouges/brunes laissées par d'anciens boutons.",
    "- pores — 1=invisibles · 4=nettement dilatés (joues, nez).",
    "- texture (grain de peau) — 1=lisse · 4=rugueux, irrégulier, visible.",
